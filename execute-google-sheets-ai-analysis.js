// Execute Google Sheets AI Analysis - Access Your Sheet and Create New Tab
const { GoogleSpreadsheet } = require('google-spreadsheet');
const { JWT } = require('google-auth-library');

class JegoDigitalSheetAI {
    constructor() {
        // Your Google Sheets configuration
        this.spreadsheetId = '1nzknj5DlU_1oXeu_7VcMRD6_FRcSkgef2I0ObXxYoLg';
        
        // Service account authentication with the private key you provided
        this.serviceAccountAuth = new JWT({
            email: 'jegodigital-sheets-writer@jegodigital-leads-scraping.iam.gserviceaccount.com',
            key: `-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----`,
            scopes: [
    ...
    async initialize() {
        try {
            ...
            console.log(`👤 Service Account: jegodigital-sheets-writer@jegodigital-leads-scraping.iam.gserviceaccount.com`);
    ...
    async createAIAnalysisTab(leads) {
        try {
...
async function main() {
    const sheetAI = new JegoDigitalSheetAI();
...
module.exports = JegoDigitalSheetAI;
