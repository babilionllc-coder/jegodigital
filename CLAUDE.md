...
| 20 | FB Ad Work Starts With fb-ads-master Skill | Any agent (orchestrator OR spawned sub-agent) that touches Meta/FB paid ads — building creatives, scoring, auditing, activating, scaling, post-mortem — MUST read `skills_patches/fb-ads-master/` `boot_sequence` FIRST: SKILL.md → JEGODIGITAL_LOCKS.md → FAILURES_TO_AVOID.md → RESEARCH.md → SCORECARD.md → BUILD_CHECKLIST.md → VALIDATORS.md → PROMPT_TEMPLATES.md. Spawning a creative agent without the PROMPT_TEMPLATES.md template = ship blocked (the 2026-05-04 dormir + 2026-05-05 v3 0/18 disasters both happened because spawned agents flew without context). The fragmented sibling skills (`fb-ad-creative-builder`, `ad-creative-scorer`, `meta-ads-jegodigital`) are SUB-MODULES of fb-ads-master, not replacements. Locked 2026-05-05. | [`skills_patches/fb-ads-master/SKILL.md`](skills_patches/fb-ads-master/SKILL.md) |
