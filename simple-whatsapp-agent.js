...
class SimpleWhatsAppAgent {
    ...
    async sendAllMessages() {
        console.log('🚀 Starting Simple WhatsApp message automation...');
    ...
    async close() {
        ...
        console.log('🔧 Simple WhatsApp Agent closed');
    }
}

// Main execution
async function main() {
    const agent = new SimpleWhatsAppAgent();
...
module.exports = SimpleWhatsAppAgent;
